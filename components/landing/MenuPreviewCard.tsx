...
/**
 * Hero-right preview: a stylized mock menu card. Purely presentational.
 * No floating badges, no fake stats — just the artifact itself.
 */
export function MenuPreviewCard() {
  return (
    <div
      role="img"
      aria-label="Example menu designed by MenuAI"
      className="border-brand-border relative overflow-hidden rounded-2xl border bg-white shadow-xl shadow-black/5"
    >
